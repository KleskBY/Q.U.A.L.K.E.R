...
float vignout = 0.75; //vignetting outer border
float vignin = 0.5; //vignetting inner border
float vignfade = 1.0; //f-stops till vignete fades
...
float Vignette()
{
	float dist = distance(TexCoord1, vec2(0.5,0.5));
	dist = smoothstep(vignout+(fstop/vignfade), vignin+(fstop/vignfade), dist);
	return clamp(dist,0.0,1.0);
}

float Blur() //skx_doom: shameless copypaste of same technique, did it because blur and vignette should have different settings
{
	float dist = distance(TexCoord1, vec2(0.5,0.5));
	dist = smoothstep(blurout+(fstop/blurfade), blurin+(fstop/blurfade), dist);
	return clamp(dist,0.0,1.0);
}
...
//KLESKBY
// skx_doom: slight convert adaptation of this http://dl.dropboxusercontent.com/u/11542084/DoF_bokeh_2.4
// skx_doom: same code working for radial blur and vignette

	float fDepth = Blur();
	
	vec2 px = PixelSize;
	float dofblur = (((fDepth)/16)*100); // * UserVec1.y;
	
//	float chroma_r = (dp_FragColor.r = dp_texture2D(Texture_First, TexCoord1 + PixelSize + vec2(0.0,1.0)).r);
	
// skx_doom: Kind of a circular shape
// with chromatic abberation

//	dp_FragColor.r += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-1, 0) * (UserVec1.y * vec2(0.0,1.0))).r;// * UserVec1.y;
//	dp_FragColor.g += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-1, 0) * (UserVec1.y * vec2(-0.866,-0.5))).g;// * UserVec1.y;	
//	dp_FragColor.b += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-1, 0) * (UserVec1.y * vec2(0.866,-0.5))).b;// * UserVec1.y;

//	dp_FragColor.r += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0, -1) * (UserVec1.y * vec2(0.0,1.0))).r;// * UserVec1.y;
//	dp_FragColor.g += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0, -1) * (UserVec1.y * vec2(-0.866,-0.5))).g;// * UserVec1.y;	
//	dp_FragColor.b += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0, -1) * (UserVec1.y * vec2(0.866,-0.5))).b;// * UserVec1.y;
...
//	dp_FragColor.r += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-0.65, 0.65) * (UserVec1.y * vec2(0.0,1.0))).r;// * UserVec1.y;
//	dp_FragColor.g += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-0.65, 0.65) * (UserVec1.y * vec2(-0.866,-0.5))).g;// * UserVec1.y;	
//	dp_FragColor.b += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-0.65, 0.65) * (UserVec1.y * vec2(0.866,-0.5))).b;// * UserVec1.y;
...
//without chromatic abberation
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-1, 0));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0, -1));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(1, 0));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0, 1));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-0.65, 0.65));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0.65, -0.65));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(0.65, 0.65));// * UserVec1.y;
	dp_FragColor += dp_texture2D(Texture_First, TexCoord1 + PixelSize * UserVec1.x * dofblur * vec2(-0.65, -0.65));// * UserVec1.y;
...
//	dp_FragColor.r = dp_texture2D(Texture_First, TexCoord1 + PixelSize + vec2(0.0,1.0) * chroma).r;
//	dp_FragColor.g = dp_texture2D(Texture_First, TexCoord1 + PixelSize + vec2(-0.866,-0.5) * chroma).g;
//	dp_FragColor.b = dp_texture2D(Texture_First, TexCoord1 + PixelSize + vec2(0.866,-0.5) * chroma).b;	

	dp_FragColor *= Vignette() * UserVec2.x;
//	dp_FragColor *= Chromatic_Aberration() * UserVec3.x;	
//	dp_FragColor = UserVec2.x * vec4(dp_FragColor.r,dp_FragColor.g,dp_FragColor.b,1.0);
	dp_FragColor /= (8.6);
#endif
#endif
